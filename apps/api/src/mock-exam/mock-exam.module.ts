...
import { MockExamSessionController } from './mock-exam-session.controller';
...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      { name: MockExamSession.name, schema: MockExamSessionSchema },
  ...
  controllers: [MockExamController, MockExamSessionController],
