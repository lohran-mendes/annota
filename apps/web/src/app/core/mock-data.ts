import type { Exam, Subject, Topic, Question, UserProgress, MockExamConfig, Deck, Flashcard } from '@annota/shared';
...
export const MOCK_FLASHCARDS: Flashcard[] = [
  {
    ...
    back: 'A = π × r² (pi vezes o raio ao quadrado)',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
  ...
  },
  {
    id: '3',
    deckId: '1',
    front: 'Qual é o Teorema de Pitágoras?',
    back: 'a² = b² + c² (hipotenusa ao quadrado igual soma dos catetos ao quadrado)',
    interval: 6,
    easeFactor: 2.5,
    repetitions: 2,
  ...
  },
  {
    id: '4',
    deckId: '1',
    front: 'Como calcular porcentagem de um valor?',
    back: 'Valor × (porcentagem / 100). Ex: 15% de 80 = 80 × 0,15 = 12',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    id: '5',
    deckId: '1',
    front: 'Qual é a fórmula do volume do cilindro?',
    back: 'V = π × r² × h (área da base vezes a altura)',
    interval: 1,
    easeFactor: 2.5,
    repetitions: 1,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    ...
    back: 'Comparação implícita entre dois elementos sem usar "como" ou "tal qual". Ex: "Ele é um touro".',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    ...
    back: 'Exagero intencional para dar ênfase. Ex: "Já te disse um milhão de vezes."',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    id: '8',
    deckId: '2',
    front: 'O que é Ironia?',
    back: 'Dizer o contrário do que se pensa, geralmente com tom de humor ou crítica. Ex: "Que lindo, tirou zero na prova!"',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    id: '9',
    deckId: '2',
    front: 'O que é Personificação (Prosopopeia)?',
    back: 'Atribuir características humanas a seres inanimados ou irracionais. Ex: "O sol sorriu para nós naquela manhã."',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    id: '10',
    deckId: '3',
    front: 'Qual é a função do sistema circulatório?',
    back: 'Transportar sangue, nutrientes e oxigênio para todas as células do corpo, e recolher resíduos como gás carbônico.',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    id: '11',
    deckId: '3',
    front: 'Onde ocorrem as trocas gasosas no pulmão?',
    back: 'Nos alvéolos pulmonares. O oxigênio passa para o sangue e o gás carbônico é liberado para ser expirado (hematose).',
    interval: 1,
    easeFactor: 2.5,
    repetitions: 1,
    nextReviewDate: new Date().toISOString(),
  ...
  },
  {
    id: '12',
    deckId: '3',
    front: 'Qual é a função do sistema nervoso?',
    back: 'Coordenar e controlar as atividades do corpo, receber e processar informações, e enviar respostas através de impulsos nervosos.',
    interval: 0,
    easeFactor: 2.5,
    repetitions: 0,
    nextReviewDate: new Date().toISOString(),
